...
if __name__ == '__main__':
    ...
    anim = animation.FuncAnimation(fig, animate, fargs = (roll_s), interval = 10, blit=False)
    anim_2 = animation.FuncAnimation(fig, animate_2, fargs = (pitch_s),  interval=10, blit=False)
    anim_3 = animation.FuncAnimation(fig, animate_3, fargs = (yaw_s),  interval=10, blit=False)
    anim_4 = animation.FuncAnimation(fig, animate_4, fargs = (ax_s), interval=10, blit=False)
    ...
    ani7 = animation.FuncAnimation(fig, animate_h1, fargs = (roll_h),  interval = 1, blit=False)
    anim_8 = animation.FuncAnimation(fig, animate_h2, fargs = (pitch_h),  interval=1, blit=False)
    anim_9 = animation.FuncAnimation(fig, animate_h3, fargs = (yaw_h),  interval=1, blit=False)
    anim_10 = animation.FuncAnimation(fig, animate_h4, fargs = (ax_h),  interval=1, blit=False)
    anim_11 = animation.FuncAnimation(fig, animate_h5, fargs = (ay_h), interval=1, blit=False)
    anim_12 = animation.FuncAnimation(fig, animate_h6, fargs = (az_h),  interval=1, blit=False)
