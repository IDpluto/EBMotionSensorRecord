...
if __name__ == '__main__':
    ...
    anim = animation.FuncAnimation(fig, animate, frames= None, interval = 100,blit=False, repeat = False)
    anim_2 = animation.FuncAnimation(fig, animate_2,  frames= None, interval=100, blit=False, repeat = False)
    anim_3 = animation.FuncAnimation(fig, animate_3, frames= None, interval=100, blit=False, repeat = False)
    anim_4 = animation.FuncAnimation(fig, animate_4, frames= None, interval=100, blit=False, repeat = False)
    anim_5 = animation.FuncAnimation(fig, animate_5,  frames= None, interval=100, blit=False, repeat = False)
    anim_6 = animation.FuncAnimation(fig, animate_6, frames= None, interval=100, blit=False, repeat = False)

    ani7 = animation.FuncAnimation(fig, animate_h1,   frames= None, interval = 100, blit=False, repeat = False)
    anim_8 = animation.FuncAnimation(fig, animate_h2,  frames= None, interval=100, blit=False, repeat = False)
    anim_9 = animation.FuncAnimation(fig, animate_h3,  frames= None, interval=100, blit=False, repeat = False)
    anim_10 = animation.FuncAnimation(fig, animate_h4,  frames= None, interval=100, blit=False, repeat = False)
    anim_11 = animation.FuncAnimation(fig, animate_h5,  frames= None, interval=100, blit=False, repeat = False)
    anim_12 = animation.FuncAnimation(fig, animate_h6, frames= None, interval=100, blit=False, repeat = False)
    plt.show()
    ser.close
